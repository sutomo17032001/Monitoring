<?php
    ...
    //ambil nama unit
    $sql3 = "SELECT u.nama_unit FROM unit u JOIN pegawai p ON p.id_unit = u.id_unit WHERE p.id_pegawai='$id'";
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php
                                            $sql = "SELECT c.id_cuti FROM cuti c JOIN pegawai p ON c.id_pegawai = p.id_pegawai WHERE p.id_pegawai = '$id' AND c.status_cuti = 0";
                                            $result = mysqli_query($conn, $sql);
                                    ...
                                    <div class="frontside shadow">
                                        <div class="card">
                                            ...
                                            <div class="card-body text-center">
                                                ...
                                                <p class="card-text"><?php echo $row3["jabatan_pegawai"]; ?></p>
                                    ...
                                    <div class="backside shadow">
                                        <div class="card">
                                            <div class="card-body text-center mt-4">
                                                <h4 class="card-title"> Unit : <?php echo $row2["nama_unit"]; ?></h4>
...
<?php 
        ...
        $sql1 = "SELECT COUNT(*) AS x FROM absensi a JOIN pegawai p ON p.id_pegawai = a.id_pegawai WHERE MONTH(a._timestamp) = MONTH(CURRENT_DATE) AND p.id_pegawai = '$id' ";
        ...
        $sql3 = "SELECT DAY(LAST_DAY( NOW() )) AS z";
