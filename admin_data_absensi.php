                    ...
                    $.post("set_cuti.php", 
                        ...
                        function(data, status){
                            ...
                            for (var i = 1;i <= len;i++) {
                                ...
                                res += "<div class='status-indicator bg-sucesss'></div>";
                                res += "</div>";
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Seluruh Karyawan</h1>
                            <a href="generate_report.php?test=1"  class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                    ...
                                    <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                //loop untuk tiap pegawai
                                                while($result = mysqli_fetch_array($query)){
                                                    //ambil data hadir
                                                    $sql1 = "SELECT COUNT(_timestamp) AS hadir FROM absensi WHERE MONTH(_timestamp) = MONTH(CURRENT_DATE) AND id_pegawai = '".$result['id_pegawai']."' ";
                                                    $query1 = mysqli_query($conn, $sql1);
                                                    $result1 = mysqli_fetch_assoc($query1);
                                                    //ambil data terlambat
                                                    $sql2 = "SELECT COUNT(_timestamp) AS telat FROM absensi WHERE MONTH(_timestamp) = MONTH(CURRENT_DATE) AND terlambat = 1 AND id_pegawai = '".$result['id_pegawai']."'";
                                                    $query2 = mysqli_query($conn, $sql2);
                                                    $result2 = mysqli_fetch_assoc($query2);
                                                    //ambil data sakit
                                                    $sql3 = "SELECT COUNT(_time) AS sakit FROM cuti WHERE MONTH(_time) = MONTH(CURRENT_DATE) AND id_katagoricuti = 1 AND id_pegawai = '".$result['id_pegawai']."' ";
                                                    $query3 = mysqli_query($conn, $sql3);
                                                    $result3 = mysqli_fetch_assoc($query3);
                                                    //ambil data cuti
                                                    $sql4 = "SELECT COUNT(_time) AS cuti FROM cuti WHERE MONTH(_time) = MONTH(CURRENT_DATE) AND NOT id_katagoricuti = 1 AND id_pegawai = '".$result['id_pegawai']."' ";
        ...
        <script>
            $(document).ready(function () {
                ...
                $('#dataTable1 tbody').on('click', 'td.detail-control', function () {
                    ...
                    createCookie("test1234", data[1] , "10");
                    window.location.href = "admin_detail_absensi.php";
                });
            });
        </script>  
        <style>
